...
-> loosely coupled
-> It forces all the implementation classes to have same method name resulting in good design
...
Note: Default Constructors in java?
During compilation automatically empty body ZERO args constructor is added to .class file when developer doesnot creates a constructor explicitly
...
//No Error because default constructor will get created
...
//Error because default constructor will not get created for constructor with arguments 
...
//Error because default constructor will not get created when object with and without args are created in same program
